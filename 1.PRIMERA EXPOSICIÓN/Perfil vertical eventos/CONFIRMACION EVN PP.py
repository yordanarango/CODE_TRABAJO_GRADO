...
V = nc.Dataset('/home/yordan/YORDAN/TRABAJO_DE_GRADO/DATOS_Y_CODIGOS/DATOS/VIENTO V a 10 m (promedio mensual).nc')
U = nc.Dataset('//home/yordan/YORDAN/TRABAJO_DE_GRADO/DATOS_Y_CODIGOS/DATOS/VIENTO U a 10 m (promedio mensual).nc')
...
an_u_evn = np.zeros((7,97,121))
an_v_evn = np.zeros((7,97,121))
...
box_PP_lon = [-90.8, -90.8, -86, -86, -90.8]
box_PP_lat = [11.2, 7.2, 7.2, 11.2, 11.2]
...
ax.set_title('$Anomalia$ $media$ $del$ $evento-Papagayo-(Ene/2003)$', size='15')
