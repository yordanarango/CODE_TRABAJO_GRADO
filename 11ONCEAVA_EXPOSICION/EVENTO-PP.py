...
Archivo = nc.Dataset('/home/yordan/Escritorio/TRABAJO_DE_GRADO/DATOS_Y_CODIGOS/DATOS/EVENTOS CHORROS ERA/EVN-PP-SSHyST-1998-01-01.nc')
...
lat_indx = 8 # 11.11999989
lon_indx = 6 # --87.03997803
...
my_xticks = pd.date_range('1997-12-30', '1998-01-03', freq='D')
Time = np.arange(0,len(TIME), 8)
plt.xticks(Time, my_xticks, size=7)#rotation=90

ca.set_label('C')
ax1.set_title('Temporal evolution of temperature profile (PP)', size='13')
