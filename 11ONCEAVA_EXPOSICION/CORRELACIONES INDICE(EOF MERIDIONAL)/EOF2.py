...
down1  = np.where(latPR == 13.5)[0][0]
left1  = np.where(lonPR == -86)[0][0]
right1 = np.where(lonPR == -71)[0][0]
...
plot_mapa(corr_meridional, 'Wind Meridional', Lat, Lon)
