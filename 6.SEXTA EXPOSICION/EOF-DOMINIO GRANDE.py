# -*- coding: utf-8 -*-
"""
Created on Wed Oct  5 05:52:30 2016
...
PR = nc.Dataset('/home/yordan/YORDAN/UNAL/TRABAJO_DE_GRADO/DATOS_Y_CODIGOS/DATOS/PRESION-SEA-LEVEL-ERA/MSLP_1979_2016_MENSUAL.nc')
...
map = Basemap(projection='merc', llcrnrlat=0, urcrnrlat=40, llcrnrlon=-120, urcrnrlon=-55, resolution='h')
...
CF = map.contourf(x,y, PC[1], np.linspace(-15, 23, 30), extend='both', cmap=plt.cm.RdYlBu_r)#plt.cm.rainbow
...
ax.set_title('PC-2  [11.7%]', size='15', weight='medium')
plt.show()
