...
FECHAS = pd.date_range('1979/01/01 00:00:00', '1987-12-31 23:00:00', freq='6H')
...
def remov_ciclo_v(UyV, LAT, LON, wh, fechas, FECHAS):
...
spd_ano, spd_media = remov_ciclo_v(UyV, Lat, Lon, wh, fechas, FECHAS)
...
#    return MAPA
#
#meridional_ano = remov_ciclo_meridional(UyV, Lat, Lon, wh, fechas)
...
plt.savefig('/home/yordan/Escritorio/TRABAJO_DE_GRADO/EXPOSICIONES/EXPOSICION_10/EOF-VELOCIDAD'+'/'+'Varianza explicada'+'.png',dpi=100,bbox_inches='tight')
plt.close('all')
...
#MAPAS CON SSP
plot_mapa(PC1_SSP, 'SSP', 1, '/home/yordan/Escritorio/TRABAJO_DE_GRADO/EXPOSICIONES/EXPOSICION_10/IMAGENES-CORRELACIONES', latSSP, lonSSP)
plot_mapa(PC2_SSP, 'SSP', 2, '/home/yordan/Escritorio/TRABAJO_DE_GRADO/EXPOSICIONES/EXPOSICION_10/IMAGENES-CORRELACIONES', latSSP, lonSSP)
plot_mapa(PC3_SSP, 'SSP', 3, '/home/yordan/Escritorio/TRABAJO_DE_GRADO/EXPOSICIONES/EXPOSICION_10/IMAGENES-CORRELACIONES', latSSP, lonSSP)
plot_mapa(PC4_SSP, 'SSP', 4, '/home/yordan/Escritorio/TRABAJO_DE_GRADO/EXPOSICIONES/EXPOSICION_10/IMAGENES-CORRELACIONES', latSSP, lonSSP)
